...
headers = {
  ...
  'referer': 'https://spb.etagi.com/commerce/',
  ...
  'Cookie': '_ga_sync=wrokGmVAAjlCiAAJBLwuAg=='
}
...
with open('spb.csv', 'w', newline='', encoding='utf-8-sig') as file:
    ...
    for url in urls:
        ...
        while True:
            if page == 0:
                ...
                if index==0:
                    link=url[:935]+str(page)+url[936:]
                elif index==1:
                    link=url[:898]+str(page)+url[899:]
                elif index==2:
                    link=url[:965]+str(page)+url[966:]
                elif index==3:
                    link=url[:793]+str(page)+url[794:]
            ...
            if data['data'] == []:
                ...
                for object in data['data']:
                    ...
                    if object_id==10144468 or object_id=='10144468':
                        time.sleep(5)
                    print(object_id)
                    user = '@andrtazet'
