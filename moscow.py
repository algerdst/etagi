...
headers = {
    ...
    'Cookie': '_ga_sync=wrokGmU8r2mOMgUJBypSAg=='
}
...
with open('moscow.csv', 'w', newline='', encoding='utf-8-sig') as file:
    ...
    for url in urls:
        ...
        while True:
            if page == 0:
                ...
                if index == 0:
                    link = url[:941] + str(page) + url[941:]
                elif index == 1:
                    link = url[:903] + str(page) + url[904:]
                elif index == 2:
                    link = url[:970] + str(page) + url[971:]
                elif index == 3:
                    link = url[:798] + str(page) + url[799:]
            ...
            if data['data'] == []:
                ...
                for object in data['data']:
                    ...
                    if purpose in ['Квартира', 'Апартаменты/Студия', 'Малосемейка', 'Дом', 'Дача', 'Таунхаус',
                                   'Комната', 'Общежитие', 'Коттедж']:
                        form = 'Жилая'
                    else:
                        form = 'Не жилая'
                    city = 'Москва'
